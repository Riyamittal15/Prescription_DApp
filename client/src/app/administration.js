...
class Administration extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      const PrescriptionsContractNetwork =
      ...
      this.setState({
        ...
        prescriptions_contract: PrescriptionsContractInstance,
        initialize: true,
      });
      this.checkVerification();
    } catch (error) {
  ...
  connectSmartContractUser = async () => {
    ...
    await prescriptions_contract.methods
      .establishConnectionToUserSmartContract(smart_contract_key)
  ...
  checkVerification = async () => {
    ...
    const verfied = await userContract.methods
      .checkVerification("verifying_institution", this.state.account)
      .call({ from: this.state.standardAccount, gas: 1000000 });
  ...
  getInsured = async () => {
    ...
    const returnedValue = await userContract.methods
      .getInsured(insured_address_)
  ...
  verifyInsured = async () => {
    ...
    await userContract.methods
      .verifyInsured(insured_address_)
      .send({ from: accounts[0], gas: 1000000 });
    this.setState({ transactionComplete: true });
  };
  ...
  getPhysician = async () => {
    ...
    const returnedValue = await userContract.methods
      .getPhysician(physician_address_)
      .call({ from: accounts[0], gas: 1000000 });
    console.log(returnedValue);
  };
  ...
  verifyPhysician = async () => {
    ...
    const physician_address_ = formData.physician_address;
    await userContract.methods
      .verifyPhysician(physician_address_)
      .send({ from: accounts[0], gas: 1000000 });
    this.setState({ transactionComplete: true });
  };
  ...
  getPharmacist = async () => {
    ...
    const returnedValue = await userContract.methods
      .getPhysician(pharmacist_address_)
      .call({ from: accounts[0], gas: 1000000 });
    console.log(returnedValue);
  };
  ...
  verifyPharmacist = async () => {
    ...
    const pharmacist_address_ = formData.pharmacist_address;
    await userContract.methods
      .verifyPharmacist(pharmacist_address_)
      .send({ from: accounts[0], gas: 1000000 });
    this.setState({ transactionComplete: true });
  };
                  ...
                  <Form>
                    <Form.Group controlId="user_smart_contract">
                      <Form.Control
                        ...
                        onChange={this.handleChange}
                        type="text"
                        placeholder="Addresse des Smart Contracts User"
                      ></Form.Control>
                    </Form.Group>
                  </Form>
