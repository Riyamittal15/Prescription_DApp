...
class NewPrescription extends Component {
  ...
  checkVerification = async () => {
    ...
    const verfied = await userContract.methods
      .checkVerification("physician", this.state.account)
      ...
      try {
        ...
        await prescriptionsContract.methods
          .newPrescription({
            ...
            insured,
            pharmacist,
            pharmacistEqualsInsured,
            status,
            medicine_name,
            medicine_amount,
          })
          .send({ from: physician, gas: 1000000 });
        ...
        return (
          <>
            <Navbar sticky="top" bg="light" variant="dark" expand="lg">
              <Navbar.Brand style={{ color: "#1eb2a6" }} href="/physician">
                Tru Pharma
              </Navbar.Brand>
                ...
                <Col>
                  <Form>
                    <Form.Group controlId="public_key_patient">
                      <Form.Control
                        type="text"
                        placeholder="Public Key of the Insured"
                    ...
                    <Form.Group controlId="medicine_amount">
                      <Form.Control
                        ...
                        onChange={this.handleChange}
                        type="text"
                        placeholder="Menge of the Medication"
                      ></Form.Control>
                    </Form.Group>
                  </Form>
                  ...
                  <Button
                    className="button2"
                    block
                    onClick={this.newPrescription}
                  >
                    Create a new prescription
                  </Button>

                  <Alert
                    show={this.state.sendingError}
                    variant="danger"
                    className="mt-3"
                  >
